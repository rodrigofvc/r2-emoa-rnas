...
# python rnas_search.py --seed 18906049 --algorithm r2-emoa --search_space discrete --dataset cifar10 --batch_size 32 --n_population 10 --epochs_train_individual 1 --generations 3 --prob_cross 0.9 --prob_mut 0.1 --eta_mut 3 --mu 0.1 --learning_rate 0.025 --learning_rate_min 0.001 --momentum 0.9 --weight_decay 3e-4 --report_freq 50 --gpu 0 --init_channels 8 --reduction --layers 5 --steps 4 --multiplier 4 --attack FGSM --grad_clip 0.5 --train_portion 0.5 --increase_epochs --r2_weights_dir r2_weights/weights/weights_60_40_n40.json --proxy_data_dir proxy-data/proxy_indices/proxy_indices_cifar10_resnet20_2500.npy --proxy_eval_dir proxy-data/proxy_eval/eval_proxy_indices_cifar10_192_1000.npy
...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_points_cross', type=int, default=2, help='number of crossover points')
