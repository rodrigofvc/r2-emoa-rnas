...
def r2_emoa_rnas(args_):
    ...
    if initial_generation == 0:
        ...
        logging.info(f">>>> Gen 0 | Hypervolume (4 objs, loss): {hyp_archive}, Hypervolume (2 objs, loss): {hyp_2}, Hypervolume (2 objs, acc): {hyp2_acc}, R2: {r2_archive}")
    ...
    for generation in range(initial_generation, args.generations):
        ...
        logging.info(f">>>> Gen {generation} | Hypervolume (4 objs, loss): {hyp_archive}, Hypervolume (2 objs, loss): {hyp_2}, Hypervolume (2 objs, acc): {hyp2_acc}, R2: {r2_archive}")
        logging.info(
