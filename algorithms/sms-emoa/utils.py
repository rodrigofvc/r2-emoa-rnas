...
def store_metrics(architectures_evaluated, population, population_2, args, weights_r2, statistics):
    ...
    row_hyp = ['sms-emoa', args.dataset, args.attack, architectures_evaluated, 'hv', hyp, args.save_path_final_model.replace("\\", "/")]
    row_hyp2 = ['sms-emoa', args.dataset, args.attack, architectures_evaluated, 'hv_2obj', hyp2, args.save_path_final_model.replace("\\", "/")]
    row_r2 = ['sms-emoa', args.dataset, args.attack, architectures_evaluated, 'r2', r2_population, args.save_path_final_model.replace("\\", "/")]
