...
def moras_rnas(args):
    ...
    for gen in range(args.generations):
        ...
        store_population_data(gen, pop_X, pop_obj, algorithm.problem.archive,
...
if __name__ == '__main__':
    ...
    if args.reload_dir is None:
        results_dir = create_experiment_dir('moras', args.dataset, args.seed)
    ...
    archive, archive_losses, statistics = moras_rnas(args)
