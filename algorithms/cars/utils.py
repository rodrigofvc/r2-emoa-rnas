...
def store_metrics(architectures_evaluated, population, population_2, args, weights_r2, statistics):
    ...
    row_hyp = ['cars', args.dataset, args.attack, architectures_evaluated, 'hv', hyp, args.save_path_final_model.replace("\\", "/")]
    row_hyp2 = ['cars', args.dataset, args.attack, architectures_evaluated, 'hv_2obj', hyp2, args.save_path_final_model.replace("\\", "/")]
    row_r2 = ['cars', args.dataset, args.attack, architectures_evaluated, 'r2', r2_population, args.save_path_final_model.replace("\\", "/")]
...
def store_population_data(generation, pop, archive, archive_accuracy, archive_losses, statistics, time_search, save_path_final_architect):
...
def load_execution(args_dir):
    ...
    return args, statistics, generation, pop, archive, archive_accuracy, archive_losses, time_search
